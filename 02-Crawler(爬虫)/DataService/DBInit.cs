    ...
    public class DBInit
    {
        ...
        public void InitCommodityTable()
        {
            ...
            catch (Exception ex)
            {
                ...
                {
                    Console.WriteLine("初始化数据库InitCommodityTable删除的时候，原表不存在"); 
                }
                else
                {
                    Console.WriteLine("初始化数据库InitCommodityTable失败，{0}",ex); 
                    throw ex;
                }
            }
            #endregion Delete
            ...
            {
                Console.WriteLine("InitCommodityTable创建异常"); 
                throw ex;
            }
            #endregion Create
        }
        ...
        public void InitCategoryTable()
        {
            ...
            catch (Exception ex)
            {
                ...
                {
                    Console.WriteLine("初始化数据库InitCategoryTable删除的时候，原表不存在"); 
                }
                else
                {
                    Console.WriteLine("初始化数据库InitCategoryTable失败，{0}",ex); 
                    throw ex;
                }
            }
            #endregion Delete
            ...
            {
                Console.WriteLine("初始化数据库InitCategoryTable 创建失败，{0}",ex); 
                throw ex;
            }
            #endregion Create
